    ...
    <section className="relative w-full h-96 md:h-screen bg-gradient-to-r from-gray-900 to-gray-800 overflow-hidden">
      ...
      <div className="relative h-full flex items-center justify-center">
        <div className="container-max text-center text-white">
          ...
          <p className="text-lg md:text-2xl mb-8 md:mb-12 text-gray-200 max-w-2xl mx-auto animate-slide-in-up">
            {subtitle}
          </p>
          <Link
            href={ctaLink}
            className="inline-block bg-accent hover:bg-red-700 text-white font-bold py-3 md:py-4 px-8 md:px-12 rounded transition transform hover:scale-105"
          >
            {ctaText}
          </Link>
        </div>
